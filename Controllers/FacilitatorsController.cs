...
namespace FA_1.Controllers
{
    public class FacilitatorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Address1,Address2,EmailID")] Facilitator facilitator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,Address1,Address2,EmailID")] Facilitator facilitator)
        {
            if (ModelState.IsValid)
            {
